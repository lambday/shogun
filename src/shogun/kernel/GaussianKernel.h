...
public:
	 ...
	 *
	 * Caussian kernel returns unknown since features can be based on anything
	 *
...
protected:
	 ...
	 * \f[
	 * 	distance({\bf x},{\bf y})= \frac{||{\bf x}-{\bf y}||_{l_2}^2}{\tau}
	 * \f]
	 */
...
private:
	 ...
	 * internally calls precompute_lhs and precomputed_rhs on the Euclidean
	 * distance object that is inside.
	 */
	void precompute_squared_norms();

	/** initializes with default values and registers parameters */
